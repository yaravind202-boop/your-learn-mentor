  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-input bg-background hover:bg-accent hover:text-accent-foreground shadow-glow",
        ...
        gradient: "bg-gradient-primary text-primary-foreground hover:opacity-90 shadow-elevated hover:shadow-glow",
        hero: "bg-gradient-secondary text-secondary-foreground hover:opacity-90 shadow-elevated hover:shadow-glow backdrop-blur-sm",
      },
      size: {
